          ...
          <div class="col-lg-9 blog-post-single">
            <div class="blog-item">
              ...
              <div class="post-content">
                ...
                <div class="blog-title">
                  <h2>
                    <nuxt-link to="/blog/1" title>perferendis doloribus asperiores.</nuxt-link>
                  </h2>
                </div>
                <div class="blog-desc">
            ...
            <div class="blog-author">
              <div class="author-bio">
                ...
                <p
                  class="author_det"
                >Lorem ipsum dolor sit amet, consectetur adip, sed do eiusmod tempor incididunt ut aut reiciendise voluptat maiores alias consequaturs aut perferendis doloribus omnis saperet docendi nec, eos ea alii molestiae aliquand.</p>
              </div>
            ...
            <div class="blog-comments">
              ...
              <div id="comment-blog">
                <ul class="comment-list">
                  <li class="comment">
                    <div class="avatar">
                      <img alt src="/images/avatar-01.jpg" class="avatar" />
                    </div>
                  ...
                  <li class="comment">
                    <div class="avatar">
                      <img alt src="/images/avatar-02.jpg" class="avatar" />
                    </div>
                    <div class="comment-container">
                      <h5 class="comment-author">
                        <a href="#">John Smith</a>
                    ...
                    <ul class="children">
                      <li class="comment">
                        ...
                        <div class="comment-container">
                          ...
                          <div class="comment-meta">
                            <a href="#" class="comment-date link-style1">February 14, 2015</a>
                            <a class="comment-reply-link link-style3" href="#respond">Reply »</a>
                          </div>
                          <div class="comment-body">
                ...
                <form action="#">
                  <div class="row">
                    ...
                    <div class="col-md-12 post-btn">
                      <button class="hover-btn-new orange">
          ...
          <div class="col-lg-3 col-12 right-single">
            ...
            <div class="widget-categories">
              ...
              <ul>
                ...
                <li>
                  <a href="#">Business Leaders Guide</a>
                </li>
                <li>
